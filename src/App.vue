            ...
            <div class="col-xs-12">
                ...
                <form @submit.prevent="isSubmitted = true">
                    <div class = "form-group">
                        ...
                        <input type = "text" class = "form-control" id = "title" v-model = "post.title"></input>
                    </div>

                    <div class="form-group">
                        <label for="content">Content</label>
                        <textarea class="form-control" id="content" cols="30" rows="10" v-model="post.content"></textarea>
                    </div>

                    <div class="form-group">
                        <input type="checkbox" id="publishImmediately" v-model="post.publishImmediately">
                        <label for="publish-immediately">PublishImmediately</label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div v-for="media in formData.socialMedia">
                            <input type="checkbox" :id="media" :value="media" v-model="post.shareOn"></input>
                    ...
                    <div class="form-group">
                        ...
                        <div v-for="category in formData.categories">
                            <input type="radio" :id="category" :value="category" v-model="post.category"></input>
